    ...
    return function(t) {
        ...
        L.Timeline = L.GeoJSON.extend({
            ...
            initialize: function(t) {
                ...
                L.GeoJSON.prototype.initialize.call(this, null, n), L.Util.setOptions(this, i), L.Util.setOptions(this, n), this.options.getInterval && (this._getInterval = function() {
                    var t;
        ...
        L.TimelineSliderControl = L.Control.extend({
            initialize: function() {
                ...
                this.timelines = [], L.Util.setOptions(this, e), L.Util.setOptions(this, t), "undefined" != typeof t.start && (this.start = t.start), "undefined" != typeof t.end && (this.end = t.end)
            },
            _getTimes: function() {
                var t = this,
                    e = [];
            ...
            _recalculate: function() {
                ...
                }), t || (this.start = i, this._timeSlider.min = i === 1 / 0 ? 0 : i, this._timeSlider.value = this._timeSlider.min), e || (this.end = r, this._timeSlider.max = r === -(1 / 0) ? 0 : r), this._stepSize = Math.max(1, (this.end - this.start) / this.options.steps), this._stepDuration = Math.max(1, n / this.options.steps)
            },
            ...
            _createDOM: function() {
                ...
                if (this.container = e, this.options.enablePlayback) {
                    ...
                    this._makeButtons(i), this.options.enableKeyboardControls && this._addKeyListeners(), this._makeOutput(n)
                }
            ...
            _rebuildDataList: function() {
                for (var t = this._datalist; t.firstChild;) t.removeChild(t.firstChild);
            ...
            _makeSlider: function(t) {
                ...
                n.type = "range", n.min = this.start || 0, n.max = this.end || 0, n.value = this.start || 0, n.addEventListener("change", function(t) {
            ...
            _makeOutput: function(t) {
                this._output = L.DomUtil.create("output", "time-text", t), this._output.innerHTML = this.options.formatOutput(this.start)
            },
            ...
            addTimelines: function() {
                var t = this;
                this.pause();
                for (var e = this.timelines.length, n = arguments.length, i = Array(n), r = 0; r < n; r++) i[r] = arguments[r];
            ...
            pause: function() {
                clearTimeout(this._timer), this._playing = !1, this.container.classList.remove("playing")
            },
            play: function() {
                var t = this;
                clearTimeout(this._timer), parseFloat(this._timeSlider.value, 10) === this.end && (this._timeSlider.value = this.start), this._timeSlider.value = parseFloat(this._timeSlider.value, 10) + this._stepSize, this.setTime(this._timeSlider.value), parseFloat(this._timeSlider.value, 10) === this.end ? (this._playing = !1, this.container.classList.remove("playing")) : (this._playing = !0, this.container.classList.add("playing"), this._timer = setTimeout(function() {
                    return t.play()
                }, this._stepDuration))
            },
            next: function() {
        ...
        var o = function() {
            ...
            a = function t(e, n, i, o) {
                r(this, t), this.low = e, this.high = n, this.max = n, this.data = i, this.left = null, this.right = null, this.parent = o
            },
            s = function() {
                function t() {
                ...
                return o(t, [{
                    ...
                    value: function(t, e, n, i, r, o) {
                        var s = void 0;
                        if (null === i) s = new a(t, e, n, r), null === r ? this._root = s : r[o] = s;
                        else {
                            var l = t < i.low || t === i.low && e < i.high ? "left" : "right";
                            s = this._insert(t, e, n, i[l], i, l), i.max = Math.max(i.max, s.max)
                        }
                        return s
                    }
                }, {
